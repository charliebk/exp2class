...
public class IfcUnitaryEquipment extends IfcEnergyConversionDevice {
    ...
    public IfcUnitaryEquipmentTypeEnum PredefinedType; // OPTIONAL
    // INVERSE attributes:
    ...
    // ('IFC4X3_DEV_73740fe4.IFCUNITARYEQUIPMENTTYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));
