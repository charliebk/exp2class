...
public class IfcElectricGenerator extends IfcEnergyConversionDevice {
    ...
    public IfcElectricGeneratorTypeEnum PredefinedType; // OPTIONAL
    // INVERSE attributes:
    ...
    // ('IFC4X3_DEV_73740fe4.IFCELECTRICGENERATORTYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));
