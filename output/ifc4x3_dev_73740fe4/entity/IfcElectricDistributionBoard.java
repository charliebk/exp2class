...
public class IfcElectricDistributionBoard extends IfcFlowController {
    ...
    public IfcElectricDistributionBoardTypeEnum PredefinedType; // OPTIONAL
    // INVERSE attributes:
    ...
    // ('IFC4X3_DEV_73740fe4.IFCELECTRICDISTRIBUTIONBOARDTYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));
