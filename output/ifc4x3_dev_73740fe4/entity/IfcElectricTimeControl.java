...
public class IfcElectricTimeControl extends IfcFlowController {
    ...
    public IfcElectricTimeControlTypeEnum PredefinedType; // OPTIONAL
    // INVERSE attributes:
    ...
    // ('IFC4X3_DEV_73740fe4.IFCELECTRICTIMECONTROLTYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));
