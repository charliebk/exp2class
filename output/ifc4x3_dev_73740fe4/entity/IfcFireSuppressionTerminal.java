...
public class IfcFireSuppressionTerminal extends IfcFlowTerminal {
    ...
    public IfcFireSuppressionTerminalTypeEnum PredefinedType; // OPTIONAL
    // INVERSE attributes:
    ...
    // ('IFC4X3_DEV_73740fe4.IFCFIRESUPPRESSIONTERMINALTYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));
