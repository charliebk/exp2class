...
public class ExportEntityCSharpTest {
    ...
    public void testBasicEntityExporting() {
        ...
        String actual = entity.exportFile(ExportFiles.Language.CSHARP).toString().trim();
    ...
    public void testEntityWithUniqueClauses() {
        ...
        String expected = """
                ...
                {
                    public IfcLabel Attr1 { get; set; }
                    public IfcInteger Attr2 { get; set; }
