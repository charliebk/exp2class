Public Class IfcGeometricRepresentationSubContext Inherits IfcGeometricRepresentationContext
    Public ParentContext As IfcGeometricRepresentationContext
    Public TargetScale As IfcPositiveRatioMeasure
    Public TargetView As IfcGeometricProjectionEnum
    Public UserDefinedTargetView As IfcLabel
