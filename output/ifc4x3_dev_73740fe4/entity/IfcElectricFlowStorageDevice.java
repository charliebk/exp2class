...
public class IfcElectricFlowStorageDevice extends IfcFlowStorageDevice {
    ...
    public IfcElectricFlowStorageDeviceTypeEnum PredefinedType; // OPTIONAL
    // INVERSE attributes:
    ...
    // ('IFC4X3_DEV_73740fe4.IFCELECTRICFLOWSTORAGEDEVICETYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));
