...
public class IfcProtectiveDeviceTrippingUnit extends IfcDistributionControlElement {
    ...
    public IfcProtectiveDeviceTrippingUnitTypeEnum PredefinedType; // OPTIONAL
    // INVERSE attributes:
    ...
    // ('IFC4X3_DEV_73740fe4.IFCPROTECTIVEDEVICETRIPPINGUNITTYPE' IN TYPEOF(SELF\IfcObject.IsTypedBy[1].RelatingType));
