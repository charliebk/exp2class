...
class ExportTypeJavaTest {
    ...
    void testPrimitiveType() {
        ...
        // Exportación a Java
        String javaCode = type.exportFile(ExportFiles.Language.JAVA).toString();
        System.out.println("=== Java Output ===\n" + javaCode);

        // Verificación básica del código generado
        assertTrue(javaCode.contains("public class IfcReal"));
        assertTrue(javaCode.contains("public Double value"));
    }
